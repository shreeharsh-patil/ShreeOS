...
build_alsa() {
  ...
  local url="https://www.alsa-project.org/files/pub/${4}/${name}-${version}.tar.bz2"
  local archive="${LUMEN_BUILD_DIR}/sources/${name}-${version}.tar.bz2"
  local source="${LUMEN_BUILD_DIR}/sources/${name}-${version}"
